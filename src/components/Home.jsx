  ...
  return (
    <div className='flex flex-col h-120 lg:h-130 justify-around'>
      <span className='flex flex-col mx-12'>
        <span className='text-2xl lg:text-5xl md:text-4xl font-medium text-white leading-tight'>Your story deserves a spotlight...<br />Let your resume speak before you do.</span>
